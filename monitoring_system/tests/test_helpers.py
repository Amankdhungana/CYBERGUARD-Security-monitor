...
from monitoring_system.utils.helpers import (
    format_timestamp,
    get_severity_color,
...
class TestHelpers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import monitoring_system.utils.helpers
        def mock_connection():
            return sqlite3.connect(self.db_path)
        monitoring_system.utils.helpers.get_company_connection = mock_connection
